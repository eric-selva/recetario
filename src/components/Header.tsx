      ...
      <div className="mx-auto flex h-16 max-w-5xl items-center justify-between px-4">
        ...
        <Link href="/" className="flex items-center gap-2.5">
          <svg className="h-9 w-9" viewBox="0 0 40 40" fill="none">
            ...
            {/* Steam 1 */}
            <path d="M14 12 Q14.5 8 14 5" stroke="#5a7247" strokeWidth="2" fill="none" strokeLinecap="round" opacity="0.7" />
            {/* Steam 2 */}
            <path d="M20 11 Q20.5 7 20 4" stroke="#5a7247" strokeWidth="2" fill="none" strokeLinecap="round" opacity="0.7" />
            {/* Steam 3 */}
            <path d="M26 12 Q26.5 8 26 5" stroke="#5a7247" strokeWidth="2" fill="none" strokeLinecap="round" opacity="0.7" />
            {/* Lid knob */}
            <circle cx="20" cy="13" r="2" fill="#d4a24e" />
            {/* Highlight on pot */}
            <rect x="12" y="20" width="8" height="2" rx="1" fill="#e87a56" opacity="0.5" />
          </svg>
